...
# subset to get the basins of interest
...
```{r prism_aggregation}
# # aggregate temp and precip rasters by basin boundaries, this function takes a long time and is an "embarassingly parallel problem"
