...
# # subset to get the basins of interest, let's keep them all this time
...
```{r prism_aggregation}
# # aggregate temp and precip rasters by basin boundaries, this function takes a long time and is an "embarrassingly parallel problem"
...
```{r final_touches}
# get rid of NAs: 431 total; lots of times in NHG, and 2000-10-08	WHI, 2000-12-09	WHI, 2001-05-26	YRS, 2011-01-21	YRS, 2011-10-21	YRS. Make them 0s. 
df_nas <- moddf[is.na(moddf$FLOW),]
moddf$FLOW <- ifelse(is.na(moddf$FLOW), 0, moddf$FLOW)

# get rid of negative flows: 2675 in this dataset
