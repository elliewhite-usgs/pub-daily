...
# sptdf <- sptdf[sptdf$IN_SAC_DELTA==1,] no longer omitting basins from the study
...
# these experiments get funky when standardizing the data. I suspect it is because we want to keep the information of the distributions in, when fitting to different parts of it. Go back to relu activations without standardizing. 
